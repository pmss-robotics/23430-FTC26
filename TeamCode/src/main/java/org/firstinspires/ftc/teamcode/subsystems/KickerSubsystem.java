...
public class KickerSubsystem extends SubsystemBase {
    ...
    private final double HOME_POSITION_RIGHT = 0.4;
    private final double TARGET_POSITION_RIGHT = 0.56;
    private final double HOME_POSITION_LEFT = 0.8;
    private final double TARGET_POSITION_LEFT = 0.64;
